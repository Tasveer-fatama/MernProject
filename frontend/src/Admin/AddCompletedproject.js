...
import AddedCompletedProject from '../Admin/AddedCompleted.js'
...
const AddProject = () => {
    ...
    const addProjectForm = useFormik({
        ...
        onSubmit: async (values, { resetForm }) => {
            ...
            console.log(values);
            resetForm()
            const res = await fetch("https://mernproject-1-836a.onrender.com/completedProjects/add", {
                method: "POST",
